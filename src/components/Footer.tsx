              ...
              {[
                {
                  ...
                  to: "https://www.linkedin.com/in/akshat-jaiswal-4664a2197",
                },
                {
                  icon: GitHub,
                  label: "GitHub",
                  color: "hover:text-gray-300",
                  to: "https://github.com/Zethyst",
                },
                {
                  icon: Mail,
                  label: "Email",
                  color: "hover:text-green-400",
                  to: "mailto:ekansha13@gmail.com",
                },
              ].map((social, index) => (
                <a
                  key={index}
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-amber-400 text-lg flex items-center">
              <span>
                &copy; {new Date().getFullYear()} BookReviews. Made with
              </span>
            ...
            <div className="flex items-center space-x-6 text-amber-400">
              <span className="text-sm">Crafted by Zethyst</span>
